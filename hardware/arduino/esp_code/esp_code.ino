...
void loop(){
  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > timerDelay || sendDataPrevMillis == 0)){
    ...
    String parentPath = databasePath + "/" + "intake/";
    json.set("1", String(timestamp));
    ...
    //Getting data
    FirebaseJson jVal;
    Serial.printf("Get json ref... %s\n", Firebase.RTDB.getJSON(&fbdo, "/device/data", &jVal) ? jVal.raw() : fbdo.errorReason().c_str());
...
//      caddy1 = hour(ct1) + minute(ct1);
      ...
      Serial.print(currentTime - caddy1);
    }
  }
